...
def transcribe_english(
    ...
    """Transcribe English audio with speaker diarization.
...
def transcribe_and_translate(
    ...
    **_kwargs,
    ...
    """Alias for API symmetry with chinese_transcribe (no translation needed)."""
    return transcribe_english(audio_path, model_path)
